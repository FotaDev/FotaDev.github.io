...
ActiveRecord::Schema.define(version: 1) do
  ...
  create_table "loans", primary_key: "loanID", id: :integer, default: nil, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "multi_stock", primary_key: "multiID", id: :integer, default: nil, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "stockID", null: false
